        ...
        <Container className="resume-content">
          <Col className="home-about-description">
            ...
            <p className="home-about-body">
              <i>
                <b className="highlight">1. No Data Collection</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">2. Application Usage</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">3. Data Security</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">4. Changes to This Policy</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">5. Contact Us</b>
              </i>
              <br />
              <br />
