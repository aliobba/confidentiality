        ...
        <Container className="resume-content">
          <Col className="home-about-description">
            ...
            <p className="home-about-body">
              <i>
                <b className="highlight">1. Aucune collecte de données</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">2. Utilisation de l'application</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">3. Sécurité des données</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">4. Modifications de cette politique</b>
              </i>
              <br />
              <br />
              ...
              <br />
              <i>
                <b className="highlight">5. Nous contacter</b>
              </i>
              <br />
              <br />
